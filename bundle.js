...
var ReactTimer = function (_Component) {
    ...
    _createClass(ReactTimer, [{
        ...
        value: function renderTimer() {
            if (this.state.show) {
                return _react2.default.createElement(_Timer2.default, { ref: 'timer_xyz', onStop: this.onStop, onStart: this.props.onStart, seconds: this.props.seconds, hours: this.props.hours, minutes: this.props.minutes, start: this.props.start, count_down: this.props.count_down }, this.props.children);
            }
            return '';
        }
    }, {
        ...
        value: function render() {
            return _react2.default.createElement('div', null, this.renderTimer());
        }
    }]);
...
},{"./Timer":2,"react":31}],2:[function(require,module,exports){
'use strict';
...
},{"./TimerUtil":3,"react":31}],3:[function(require,module,exports){
"use strict";
...
exports.ReactTimer = undefined;

var _ReactTimer = require('./ReactTimer');
...
exports.ReactTimer = _ReactTimer2.default;

},{"./ReactTimer":1}],5:[function(require,module,exports){
'use strict';

var ReactTimer = require('./dist').ReactTimer;
module.exports = { ReactTimer: ReactTimer };
...
var ShowTimeComponent = function (_Component) {
    _inherits(ShowTimeComponent, _Component);

    function ShowTimeComponent(props) {
        _classCallCheck(this, ShowTimeComponent);

        var _this = _possibleConstructorReturn(this, (ShowTimeComponent.__proto__ || Object.getPrototypeOf(ShowTimeComponent)).call(this, props));

        console.log(_this.props);
        return _this;
    }

    _createClass(ShowTimeComponent, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                this.props.count_time
            );
        }
    }]);
...
var Demo = function (_Component2) {
    ...
    _createClass(Demo, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                _index.ReactTimer,
                { count_down: true, hours: 2 },
                _react2.default.createElement(ShowTimeComponent, null)
            );
        }
    }]);
...
},{"./index":5,"react":31,"react-dom":28}]},{},[32]);
